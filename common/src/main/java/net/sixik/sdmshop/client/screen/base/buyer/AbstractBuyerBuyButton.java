...
public abstract class AbstractBuyerBuyButton extends SimpleTextButton {
    ...
    public void onClicked(MouseButton mouseButton) {
        if(mouseButton.isLeft()){
            ...
            ShopDebugUtils.log("Send buy packet: {}, {}, {}", screen.shopScreen.currentShop.getUuid(), screen.shopEntry.getUuid(), screen.count);

            new SendBuyEntryC2S(screen.shopScreen.currentShop.getUuid(), screen.shopEntry.getUuid(), screen.count).sendToServer();
