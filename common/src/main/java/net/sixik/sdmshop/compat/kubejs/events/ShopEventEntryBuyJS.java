...
public class ShopEventEntryBuyJS extends PlayerEventJS {
    ...
    public ShopEventEntryBuyJS(final ShopBase base, final ShopEntry entry, final ShopTab tab, final ServerPlayer player, int count) {
        this.base = base;
        this.entry = entry;
        this.tab = tab;
        this.player = player;
