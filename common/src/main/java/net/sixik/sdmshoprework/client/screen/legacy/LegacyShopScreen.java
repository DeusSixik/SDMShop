...
//        this.entryScrollPanel.setCanAlwaysScroll(true);
    ...
    public void setProperties(){
        Vector2 size = new Vector2(width / 4, height);
        Vector2 additionSize = new Vector2(width - size.x, height / 8);
        int pos = size.x;
        ...
        this.entriesPanel.setSize(width - size.x, size.y);

        this.tabsScrollPanel.setPosAndSize(
                this.tabsPanel.posX + this.tabsPanel.width - this.getScrollbarWidth(),
                this.tabsPanel.posY,
                this.getScrollbarWidth(),
                this.tabsPanel.height
        );
