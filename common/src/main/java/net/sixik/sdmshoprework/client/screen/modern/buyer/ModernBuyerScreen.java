...
public class ModernBuyerScreen extends AbstractBuyerScreen {
    ...
    public void drawBackground(PoseStack graphics, Theme theme, int x, int y, int w, int h) {
        ...
        if(entryButton.entry.getEntryType() instanceof ShopItemEntryType entryType) {
            ...
            w = TextRenderHelper.getTextWidth(entryType.itemStack.getDisplayName().getString());
            ...
            w = TextRenderHelper.getTextWidth(entryButton.entry.title);
            int w1 = (this.width - 10 - 2 - sizeIcon * 2) - w;
            int w2 = w1 / 2;
        ...
        int d = TextRenderHelper.getTextWidth(textMoney);
        ...
        GLRenderHelper.pushScissor(graphics, pos.x,pos.y, size.x / 2 - 2, Minecraft.getInstance().font.lineHeight + 1);
        ...
        GLRenderHelper.pushScissor(graphics, pos.x + size.x / 2, pos.y, size.x / 2 - 2, Minecraft.getInstance().font.lineHeight + 1);
...
//        RGBA.create(0, 0, 0, 255 / 2).drawRoundFill(graphics, pos.x,pos.y, this.width - 10, this.height - (5 + sizeIcon * 2 + 2 + 24 + 2), 4);
    ...
    public void drawNewLabel(PoseStack graphics, Theme theme, Vector2 pos, Vector2 size, String left, String right) {
        RGBA.create(0, 0, 0, 255 / 2).drawRoundFill(graphics, pos.x,pos.y, size.x / 2 - 2, Minecraft.getInstance().font.lineHeight + 1, 4);
