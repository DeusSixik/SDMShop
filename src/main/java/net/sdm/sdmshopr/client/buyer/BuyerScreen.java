...
public class BuyerScreen extends BaseScreen {
    ...
    public BuyerScreen(ShopEntry<?> entry){
        ...
        this.infoField.setText(Component.translatable("sdm.shop.buyer.info.count.money", SDMShopR.getClientMoney()));
        ...
        this.outputMoneyField.setText(
            Component.translatable("sdm.shop.buyer.info.money.left", SDMShopR.getClientMoney())
        );
