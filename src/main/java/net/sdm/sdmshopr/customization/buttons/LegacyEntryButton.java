...
public class LegacyEntryButton extends APIShopEntryButton {
    ...
    public LegacyEntryButton(Panel entryPanel, ShopEntry<?> shopEntry) {
        super((EntryPanel) entryPanel, shopEntry, Component.empty(), shopEntry.type.getIcon());
    }
    ...
    public void drawBackground(GuiGraphics graphics, Theme theme, int x, int y, int w, int h) {
        ...
        theme.drawString(graphics,
                shopEntry.isSell ? Component.translatable("sdm.shop.entry.sell") : Component.translatable("sdm.shop.entry.buy"),
