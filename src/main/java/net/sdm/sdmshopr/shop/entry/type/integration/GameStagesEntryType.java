...
public class GameStagesEntryType implements IEntryType {
    ...
    public Component getTranslatableForContextMenu() {
        return new TranslatableComponent("sdm.shop.entry.add.context.integration.gamestage");
    }
    ...
    public List<Component> getDescriptionForContextMenu() {
        ...
        list.add(new TranslatableComponent("sdmr.shop.entry.creator.type.stageType.description"));
        return list;
    }
